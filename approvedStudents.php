...
<button type="submit"><img src="icon/search-512 (1) (1).webp" style="width: 30px; height: 30px;"></button>
    ...
    <div class="user">
      <a href="print/print_pdf.php" class="btn">download</a>
...
<div class="">
   ...
   <center>
		<img src="logo.png">
		<h1>KIBABII UNIVERSITY HOSTELS</h1>
		<h2>CLEARED STUDENTS REPORT</h2>
	</center>
...
$sql = "SELECT * FROM students WHERE cleared = 1 AND approved = 1";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td>';
        if ($row['cleared'] == 0) {
            echo '<a href="approve.php?id=' . $row['id'] . '">Approve</a> | <a href="reject.php?id=' . $row['id'] . '">Decline</a>';
        } else {
            echo 'Approved';
        }
        echo '</td>';

					...
					<div class="x_content">
						<table id="datatable-buttons" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<?php
								$sql = "SELECT * FROM clearence_form NATURAL JOIN clearance WHERE course_program = 'BSCE'";
								...
								<tr>
									...
									<td><?php echo $value['Lname'], '&nbsp;', $value['faculty_Mname'], '&nbsp;', $value['faculty_Lname']?></td>
...
<tr>
	...
	<td><?php echo $value['Fname'], '&nbsp;', $value['faculty_Mname'], '&nbsp;', $value['faculty_Lname']?></td>
	<td><?php echo $value['Email'] ?></td>
	<td><?php echo $value['Contact_num']?></td>
	<td><?php echo $value['Department']?></td>
	<td><?php echo $value['Designation']?></td>	

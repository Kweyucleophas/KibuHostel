...
// Check that the user has entered a subject and a message
  if ( empty($_POST['subject'] ) ) { echo '<p>You forgot to enter a query.</p>'; }
  if ( empty($_POST['message'] ) ) { echo '<p>You forgot to enter a query message.</p>'; }
...
echo '<p><a href="forum.php">Query page</a>' ;
?>
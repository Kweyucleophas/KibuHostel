	  ...
	  if ($sizeOK && $typeOK) {
		...
		if ($success) {
	      ...
	      $this->_filenames[] = $name;
			$message = "$filename uploaded successfully kindly see your janitor with your bank slip and green book to check in your room. afterwards you can log in successfully";
			if (!$this->_renamed)
			header ("location: thankyou.php"); 
			if ($this->_renamed) {
			  $message .= " the file as been renamed $name";
			  header ("location: thankyou.php"); 
			}
